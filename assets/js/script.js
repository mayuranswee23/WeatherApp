...
var populatePage = function (data){
    ...
    selectedUv = "Humidity: " + selectedUv + ' %'
...
//   dayFiveHumidity.appendChild(fiveHumidityNotation)
    ...
    for (var i =1; i<6; i++){
        ...
        var Wind = data.daily[i].wind_speed.toFixed(0)
        ...
        // console.log(date)
        var HTML = `<div class="dayOne">
        <div id="dayOneDate">${date}</div>
        <div id="dayOneIcon"><img src="http://openweathermap.org/img/wn/${Icon}@2x.png"></div>
        <div id="dayOneTemp">${Temp} °C</div>
        <div id="dayOneWind">${Wind} km/h</div>
        <div id="dayOneHumidity">${Humidity} %</div>
        </div>`
        // div.classList.add("")
        div.innerHTML = ""
        div.innerHTML = HTML
